...
(function () {
    ...
    const BADMINTON_STREAM_URLS = {
        court1: "https://cdn-vl-gcp-bornan-e-01.vos360.video/Content/LiveEvent/2d2d7315-9dfa-484c-831c-7e66c12fe329/HLS_ENC/index.m3u8",
        court2: "https://cdn-vl-gcp-bornan-e-01.vos360.video/Content/LiveEvent/d78e9ec3-8570-46d9-a770-8d0d4d895f1d/HLS_ENC/index.m3u8",
        court3: "",
        court4: "",
        court1alt: "https://pull.streamviewk7x.click/livesp/sd-6MxipX7m8AWkANWLDg_autosp.m3u8?txSecret=af8d5aa4d751f811bb7d3dbceee171b9&txTime=6AB7C1D0",
    ...
    // ============================================
    (function () {
        function lemparKeGoogle() {
            // Hentikan video dan langsung tendang ke Google
        ...
        // 1. Blokir Shortcut (Kompatibel Mac & Windows)
        document.addEventListener('keydown', function (e) {
            const isCmdOrCtrl = e.ctrlKey || e.metaKey;
            const isAltOrShift = e.shiftKey || e.altKey;

            if (
                e.key === 'F12' ||
                (isCmdOrCtrl && isAltOrShift && ['I', 'J', 'C', 'i', 'j', 'c'].includes(e.key)) ||
        ...
        // 3. Deteksi Jika DevTools Sudah Terbuka Sejak Awal (Console Getter Trap)
        const elemenJebakan = new Image();
        Object.defineProperty(elemenJebakan, 'id', {
            get: function () {
                lemparKeGoogle();
            }
        });
        ...
        setInterval(function () {
            console.log(elemenJebakan);
            console.clear();
        }, 500);

        // 4. Deteksi Perubahan Ukuran Jendela Akibat Panel DevTools
